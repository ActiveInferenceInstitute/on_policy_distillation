...
| [`generate_firstprinciples.py`](../../scripts/generate_firstprinciples.py) | firstprinciples | correspondence map, divergence/exposure/energy demos, the two-agent pymdp classroom (default; `--no-classroom` to skip), classroom-derived statistics under `output/data/firstprinciples/` |
