...
| `ross2011dagger` | DAgger; the canonical induced-distribution / dataset-aggregation result, now bound to the sequential-shift sensitivity witness as external context only. |
