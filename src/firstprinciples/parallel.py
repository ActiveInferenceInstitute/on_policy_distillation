...
def ml_distill_to_teacher(teacher: ArrayF, *, steps: int = 800, lr: float = 0.5, tol: float = 1e-5) -> MLDistillResult:
    ...
    loss is minimised (at zero) exactly when the student equals the teacher.
    """
    import jax
