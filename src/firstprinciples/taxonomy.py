...
METHODS: tuple[Method, ...] = (
    ...
    Method(
        ...
        2026,
        "liu2026pwopsd",
        "position_weighted_reliability",
        "position_weighted_clipped_forward_kl",
        True,
        True,
        "Teacher-token reliability pressure case: token position acts as a trajectory-level reliability prior, not a local toy result.",
    ),
    Method(
