...
_BASE_SCHOLARSHIP_SOURCES: tuple[dict[str, Any], ...] = (
    ...
    },
    {
        ...
        "method_role": "dataset_aggregation_induced_distribution_shift",
        "tracks": ["prose", "scholarship"],
        "artifact": "output/data/firstprinciples/sequential_shift_sensitivity.json",
        "manuscript_sections": ["intro_motivation", "results_si_tmaze"],
        "source_locator": "PMLR v15 Ross et al. 2011, Abstract and Sections 2-3",
        "source_heading": "A Reduction of Imitation Learning and Structured Prediction to No-Regret Online Learning",
        "claim_boundary": "induced-distribution shift and dataset-aggregation context only; local correction-dose rows are finite toy artifacts",
    },
    {
