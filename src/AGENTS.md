...
- The analytical, first-principles, simulation/pymdp, GNN, ontology, Lean,
  visualization, and validation-spine tracks must stay concordant: numeric
  results, notation, proof boundaries, provenance, and manuscript claims
  describe the same objects. Use `gnn/concordance.py`, `validation_spine/`, and
  `gates/validation.py` to enforce this.
...
| First principles | `firstprinciples/` | OPD/Active-Inference correspondence artifacts and classroom evidence |
