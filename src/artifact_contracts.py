...
REQUIRED_OUTPUTS: tuple[str, ...] = _unique((
    ...
    "output/data/firstprinciples/privilege_sweep.json",
    "output/data/firstprinciples/sequential_shift.json",
    "output/data/firstprinciples/sequential_shift_sensitivity.json",
    "output/data/firstprinciples/active_selection_demo.json",
    "output/data/firstprinciples/active_selection_general_demo.json",
    "output/data/firstprinciples/sequential_selection_demo.json",
    "output/data/firstprinciples/si_bridge_demo.json",
    "output/data/firstprinciples/precision_ledger_demo.json",
...
ARTIFACT_PRODUCERS: dict[str, str] = {
    ...
    "output/data/firstprinciples/privilege_sweep.json": "generate_firstprinciples.py",
    ...
    "output/data/firstprinciples/active_selection_demo.json": "generate_firstprinciples.py",
    "output/data/firstprinciples/active_selection_general_demo.json": "generate_firstprinciples.py",
    "output/data/firstprinciples/sequential_selection_demo.json": "generate_firstprinciples.py",
    "output/data/firstprinciples/si_bridge_demo.json": "generate_firstprinciples.py",
    "output/data/firstprinciples/precision_ledger_demo.json": "generate_firstprinciples.py",
...
ARTIFACT_CONSUMERS: dict[str, tuple[str, ...]] = {
    ...
    "output/data/firstprinciples/privilege_sweep.json": ("results_si_tmaze", "appendix_full_sheaf"),
    "output/data/firstprinciples/sequential_shift.json": ("results_si_tmaze", "discussion_outlook"),
    "output/data/firstprinciples/sequential_shift_sensitivity.json": ("results_si_tmaze", "discussion_outlook"),
    "output/data/firstprinciples/active_selection_demo.json": ("results_free_energy",),
    "output/data/firstprinciples/active_selection_general_demo.json": ("results_free_energy",),
    "output/data/firstprinciples/sequential_selection_demo.json": ("results_free_energy",),
    "output/data/firstprinciples/si_bridge_demo.json": ("results_free_energy",),
    "output/data/firstprinciples/precision_ledger_demo.json": ("results_free_energy",),
    ...
    "output/figures/sequential_shift_recovery.png": ("results_si_tmaze",),
    "output/figures/sequential_shift_sensitivity.png": ("results_si_tmaze",),
...
ARTIFACT_GATES: dict[str, tuple[str, ...]] = {
    ...
    "output/figures/sequential_shift_recovery.png": ("validate_outputs", "figure_registry"),
    "output/figures/sequential_shift_sensitivity.png": ("validate_outputs", "figure_registry"),
    ...
    "output/data/firstprinciples/privilege_sweep.json": ("validate_outputs", "validate_manuscript"),
    "output/data/firstprinciples/sequential_shift.json": ("validate_outputs", "validate_manuscript"),
    "output/data/firstprinciples/sequential_shift_sensitivity.json": ("validate_outputs", "validate_manuscript"),
    "output/data/firstprinciples/active_selection_demo.json": ("validate_outputs", "validate_manuscript"),
    "output/data/firstprinciples/active_selection_general_demo.json": ("validate_outputs", "validate_manuscript"),
    "output/data/firstprinciples/sequential_selection_demo.json": ("validate_outputs", "validate_manuscript"),
    "output/data/firstprinciples/si_bridge_demo.json": ("validate_outputs", "validate_manuscript"),
    "output/data/firstprinciples/precision_ledger_demo.json": ("validate_outputs", "validate_manuscript"),
