...
**A Finite-Model Active-Inference Reading of On-Policy Distillation** — *declared variational objects, finite toy witnesses, and source-bound manuscript gates.*
